...
export default function Listing() {
    ...
    return (
        <main>
            ...
            <p className='bg-red-900 w-full max-w-[200px] text-white text-center p-1 rounded-md'>
              ...
              {listing.offer && typeof listing.regularPrice === 'number' && typeof listing.discountedPrice === 'number' ? (
  ...
  <p>
     Regular Price - {listing.regularPrice}
            ...
            {currentUser && listing.userRef !== currentUser.data.user.userid && !contact &&  (

            <button onClick={()=>setcontect(true)} className='bg-slate-700 text-white rounded-lg uppercase hover:opacity-95'>Contect Landlord</button>
            )}
